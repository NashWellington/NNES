...
int ISA::executeOpcode(CPU& cpu, ubyte instr)
{
    ...
    switch (instr)
    {
        ...
        case 0x0C: // NOP abs
            LOG_INSTR("NOP", 2);
            std::tie(address, cycles) = Mode::absolute(cpu, 0, true);
            cycles += 1;
            return cycles;
        ...
        case 0x0E: // ASL abs
            LOG_INSTR("ASL", 2);
            std::tie(address, cycles) = Mode::absolute(cpu, 0, false);
            cycles += 3;
            val = cpu.read(address);
            return ASL(cpu, cycles, address, val, false);
        ...
        case 0x14: // NOP zpg,X
            LOG_INSTR("NOP", 11);
            std::tie(address, cycles) = Mode::zeroPage(cpu, cpu.reg_x);
            cycles += 1;
            return cycles;
        ...
        case 0x96: // STX zpg,Y
            LOG_INSTR("STX", 12);
            std::tie(address, cycles) = Mode::zeroPage(cpu, cpu.reg_y);
            cycles += 1;
            return STX(cpu, cycles, address);
...
int ISA::ADC(CPU& cpu, int cycles, byte val)
{
    byte a = cpu.reg_a;
...
int ISA::AND(CPU& cpu, int cycles, byte val)
{
    val &= cpu.reg_a;
    cpu.reg_sr.z = (val == 0);
    cpu.reg_sr.n = (val < 0);
...
int ISA::ASL(CPU& cpu, int cycles, uword address, byte val, bool flag_accumulator)
{
...
int ISA::BIT(CPU& cpu, int cycles, byte val)
{
...
int ISA::CMP(CPU& cpu, int cycles, byte val)
{
    byte a = cpu.reg_a;
    byte result = a - val;
...
int ISA::CPX(CPU& cpu, int cycles, byte val)
{
    byte x = cpu.reg_x;
    byte result = x - val;
...
int ISA::CPY(CPU& cpu, int cycles, byte val)
{
    byte y = cpu.reg_y;
    byte result = y - val;
...
int ISA::EOR(CPU& cpu, int cycles, byte val)
{
    // A EOR M
    byte result = cpu.reg_a ^ val;
...
int ISA::LDA(CPU& cpu, int cycles, byte val)
{
...
int ISA::LDX(CPU& cpu, int cycles, byte val)
{
...
int ISA::LDY(CPU& cpu, int cycles, byte val)
{
...
int ISA::LSR(CPU& cpu, int cycles, uword address, byte val, bool flag_accumulator)
{
...
int ISA::ORA(CPU& cpu, int cycles, byte val)
{
    // A OR M
    val = cpu.reg_a | val;
...
int ISA::ROL(CPU& cpu, int cycles, uword address, byte val, bool flag_accumulator)
{
    // Rotate one bit left
...
int ISA::ROR(CPU& cpu, int cycles, uword address, byte val, bool flag_accumulator)
{
...
int ISA::SBC(CPU& cpu, int cycles, byte val)
{
    return ADC(cpu, cycles, ~val);
}
...
int ISA::ALR(CPU& cpu, int cycles, byte val)
{
    AND(cpu, 0, val);
...
int ISA::ANC(CPU& cpu, int cycles, byte val)
{
    AND(cpu, 0, val);
    byte a = cpu.reg_a;
    cpu.reg_sr.c = (a < 0);
...
int ISA::ARR(CPU& cpu, int cycles, byte val)
{
    AND(cpu, 0, val);
...
int ISA::AXS(CPU& cpu, int cycles, byte val)
{
...
int ISA::LAX(CPU& cpu, int cycles, byte val)
{
    LDA(cpu, 0, val);
    TAX(cpu);
    return cycles;
...
int ISA::LXA(CPU& cpu, int cycles, byte val)
{
    cpu.reg_a = val;
    cpu.reg_x = val;
    cpu.reg_sr.z = (val == 0);
